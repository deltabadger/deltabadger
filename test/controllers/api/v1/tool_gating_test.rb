...
class Api::V1::ToolGatingTest < ActionDispatch::IntegrationTest
  GATES = {
    ...
    'sync_tracker' => [:post, '/api/v1/tracker/sync'],
    'set_transfer_link' => [:post, '/api/v1/transactions/account/1/transfer_link'],
    'set_transaction_price' => [:patch, '/api/v1/transactions/account/1/price'],
