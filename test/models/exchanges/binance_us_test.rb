...
class Exchanges::BinanceUsTest < ActiveSupport::TestCase
  setup do
    @exchange = create(:binance_us_exchange)
  ...
  test 'get_api_key_validity validates trading key permissions' do
    ...
    Honeymaker::Clients::BinanceUs.any_instance.stubs(:api_description).returns(
