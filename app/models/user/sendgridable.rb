module User::Sendgridable
  ...
  SENDGRID_MINI_USERS_LIST_NAME      = ENV.fetch('SENDGRID_MINI_USERS_LIST').freeze
  SENDGRID_STANDARD_USERS_LIST_NAME  = ENV.fetch('SENDGRID_STANDARD_USERS_LIST').freeze
  ...
  SENDGRID_RESEARCH_USERS_LIST_NAME  = ENV.fetch('SENDGRID_RESEARCH_USERS_LIST').freeze
