module User::Sendgridable
  ...
  SENDGRID_NEW_USERS_LIST_NAME       = ENV.fetch('SENDGRID_NEW_USERS_LIST')
  SENDGRID_FREE_USERS_LIST_NAME      = ENV.fetch('SENDGRID_FREE_USERS_LIST')
  SENDGRID_MINI_USERS_LIST_NAME      = ENV.fetch('SENDGRID_MINI_USERS_LIST')
  SENDGRID_STANDARD_USERS_LIST_NAME  = ENV.fetch('SENDGRID_STANDARD_USERS_LIST')
  SENDGRID_PRO_USERS_LIST_NAME       = ENV.fetch('SENDGRID_PRO_USERS_LIST')
  SENDGRID_LEGENDARY_USERS_LIST_NAME = ENV.fetch('SENDGRID_LEGENDARY_USERS_LIST')
  SENDGRID_RESEARCH_USERS_LIST_NAME  = ENV.fetch('SENDGRID_RESEARCH_USERS_LIST')
  KRAKEN_STARTED                     = ENV.fetch('SENDGRID_KRAKEN_STARTED')
