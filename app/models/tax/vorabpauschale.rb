module Tax
  class Vorabpauschale
    ...
    # acquired_on must fall on or before Dec 31 of computation_year; the caller must not invoke
    # this for later lots.
    def self.for_lot(computation_year:, acquired_on:, start_value_eur:, end_value_eur:, distributions_eur:)
      ...
      basisertrag = basisertrag * (13 - acquired_on.month) / 12.to_d if acquired_on.year == computation_year
