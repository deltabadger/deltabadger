module ColorsHelper
  ...
  def rgb_to_hex(r, g, b) # rubocop:disable Naming/MethodParameterName
    color_code = [r, g, b].map { |x| x.to_s(16).rjust(2, '0') }.join
    "##{color_code}"
  end

  def calculate_luminance(r, g, b) # rubocop:disable Naming/MethodParameterName
    r /= 255.0
    g /= 255.0
    b /= 255.0
