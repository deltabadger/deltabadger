    ...
    <div className="db-bots__item db-bot-data">
      ...
      <div className="tab-content" id="botFormInfo">
        <div className="tab-pane show active pl-4 pr-4" id="botFormInfoTab" role="tabpanel" aria-labelledby="botFormInfoTab">
          ...
          <p>Deltabadger works with cryptoexchanges. At the moment, we support <a href="https://auth.bitbay.net/ref/PX1icIHeUlAL" target="_blank" rel="noopener" title="Bitbay">Bitbay</a> and <a href="https://r.kraken.com/deltabadger" target="_blank" rel="noopener" title="Kraken">Kraken</a>. We recommend Kraken as a reputable exchange that has never been hacked. Use Bitbay if you want to make your purchases with PLN.</p>
