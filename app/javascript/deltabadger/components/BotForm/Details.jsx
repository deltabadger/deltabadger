    ...
    <div className="db-bots__item db-bots__item--data">
      ...
      <div className="tab-content" id="botFormInfo">
        <div className="tab-pane show active pl-4 pr-4" id="botFormInfoTab" role="tabpanel" aria-labelledby="botFormInfoTab">
          ...
          <p class="alert alert-success"><span class="badge badge-success">Nowość!</span> Użyj <a href="https://auth.bitbay.net/ref/Hhb7ZrAv2GrA" target="_blank" rel="noopener" title="Bitclude">BitClude</a> jeśli szukasz giełdy w języku polskim o bardzo atrakcyjnych marżach.</p>
