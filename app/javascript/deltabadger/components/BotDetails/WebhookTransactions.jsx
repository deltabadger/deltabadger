    ...
    <div className={`tab-pane show ${active ? 'active' : ''}`} id="statistics" role="tabpanel" aria-labelledby="stats-tab">
      { !newBot ? <>
          ...
          <div className="db-bot-info__footer">
            <a href={`/api/bots/${bot.id}/transactions_csv`} className="sbutton sbutton--link sbutton--export-to-csv">
          ...
          <p className="db-smallinfo">
            ...
            <sup>*</sup>
            <RawHTML tag="span">{I18n.t('bots.details.info.webhook.working_and_waiting')}</RawHTML>
          </p>
        </>
      }
    </div>
