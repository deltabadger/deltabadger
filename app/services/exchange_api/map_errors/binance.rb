      ...
      def errors_mapping
        {
          ...
          'Filter failure: LOT_SIZE' => Error.new('Offer lot size is not exceeding minimums', true),
          'Filter failure: MIN_NOTIONAL' => Error.new('Offer notional is not exceeding minimums', true),
