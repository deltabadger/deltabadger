    ...
    module Kraken
      class Market < BaseMarket
        ...
        def fetch_all_symbols
          ...
          Result::Failure.new('Kraken exchange info is unavailable', RECOVERABLE.to_s)
        end
        ...
        def fetch_symbol(symbol)
          ...
          Result::Failure.new('Could not fetch chosen symbol from Kraken', RECOVERABLE.to_s)
        end
        ...
        def current_bid_ask_price(symbol)
          ...
          Result::Failure.new('Could not fetch current price from Kraken', RECOVERABLE.to_s)
        end
      end
    end
  end
