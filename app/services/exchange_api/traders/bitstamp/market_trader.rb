    ...
    module Bitstamp
      class MarketTrader < ExchangeApi::Traders::Bitstamp::BaseTrader
        def buy(base:, quote:, price:, force_smart_intervals:, smart_intervals_value:)
          ...
          buy_params = get_params(symbol, price, force_smart_intervals, smart_intervals_value)
        ...
        def sell(base:, quote:, price:, force_smart_intervals:, smart_intervals_value:)
          symbol = @market.symbol(base, quote)
          sell_params = get_params(symbol, price, force_smart_intervals, smart_intervals_value)
        ...
        def get_params(symbol, price, force_smart_intervals, smart_intervals_value)
