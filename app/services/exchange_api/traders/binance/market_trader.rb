    ...
    module Binance
      class MarketTrader < ExchangeApi::Traders::Binance::BaseTrader
        ...
        def common_order_params(symbol, price, force_smart_intervals, smart_intervals_value, is_legacy)
          price = transaction_price(symbol, price, force_smart_intervals, smart_intervals_value, is_legacy)
          return price unless price.success?

          precision = is_legacy ? @market.quote_tick_size_decimals(symbol) : @market.base_tick_size_decimals(symbol)
