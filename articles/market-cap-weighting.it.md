---
title: "La Magia della Ponderazione per Capitalizzazione di Mercato"
subtitle: 'Come Trasformare Qualsiasi Portafoglio in un Fondo Indice Personale'
author_id: 1
...
La superiorità dell'approccio divenne innegabile quando l'audace previsione di Bogle del 1992 si avverò: il Vanguard 500 Index Fund superò il famoso Magellan Fund nel 2000, superando la soglia dei 100 miliardi di dollari nel novembre 1999. A quel punto, la ponderazione per capitalizzazione di mercato si era evoluta dall'esperimento ridicolizzato di Bogle alla soluzione predefinita per gli investimenti al dettaglio, con Vanguard che affrontava una vasta concorrenza in un mercato che aveva creato. <a class="link-source-tile" href="https://www.cnbc.com/2014/04/29/25-jack-bogle.html">cnbc.com</a>

Avanti veloce al 2025: **i fondi indicizzati ponderati per capitalizzazione di mercato rappresentano circa il 45% del totale degli asset in gestione (AUM) tra i fondi comuni e gli ETF a lungo termine negli Stati Uniti**, con un AUM totale di circa 30 trilioni di dollari. <a class="link-source-tile" href="https://www.ici.org/research/stats/combined_active_index">ici.org</a>
...
[AssetMarketCap](https://assetmarketcap.com) è un ottimo posto per controllare le capitalizzazioni di mercato globali di diversi asset. L'immobiliare è in cima alla lista, l'oro si posiziona quarto e Bitcoin diciottesimo. Ecco i primi 20 asset per capitalizzazione di mercato:

{::nomarkdown}
<figure class="article__figure" data-controller="pie-chart" data-pie-chart-data-value="#1bb200,RE,Immobiliare,69.94
#004081,OIL,Petrolio,11.84
#ff0000,CNY,Yuan cinese,4.84
#e7b500,GOLD,Oro,2.40
#228B22,USD,Dollaro USA,2.32
#4169E1,EUR,Euro,1.93
#B87333,CU,Rame,1.35
#87CEEB,GAS,Gas naturale,0.97
#FF69B4,JPY,Yen giapponese,0.91
#32CD32,NVDA,NVIDIA,0.46
COLUMN_BREAK
#800080,GBP,Sterlina britannica,0.44
#00BFFF,MSFT,Microsoft,0.41
#A9A9A9,AAPL,Apple Inc.,0.36
#FF8C00,KRW,Won coreano,0.33
#4B0082,HKD,Dollaro di Hong Kong,0.27
#9370DB,GOOGL,Alphabet Inc.,0.26
#FF4500,AMZN,Amazon,0.26
#F7931A,BTC,Bitcoin,0.24
#20B2AA,TWD,Dollaro taiwanese,0.23
#C0C0C0,AG,Argento,0.23">
...
<figcaption class="article__figure__caption">Top 20 asset per capitalizzazione di mercato. Fonte: <a href="https://assetmarketcap.com/">AssetMarketCap.com</a></figcaption>
</figure>
{:/nomarkdown}
...
<iframe width="100%" height="420" frameborder="0" src="https://www.theblock.co/data/crypto-markets/prices/bitcoin-dominance/embed" title="Dominanza di Bitcoin"></iframe>
</figure>
{:/nomarkdown}
...
<figcaption class="article__figure__caption">Bitcoin rappresenta quasi l'80% dell'allocazione totale nel CoinDesk 5</figcaption>
</figure>
{:/nomarkdown}
...
## Costruire il Tuo ETF Cripto Personale

Ora che sappiamo cosa e perché, è tempo di applicare questa conoscenza in pratica. Immediatamente, affrontiamo la prima sfida:
...
<figcaption class="article__figure__caption">Indice CoinMarketCap 100 (CMC100)</figcaption>
</figure>
{:/nomarkdown}
...
Come ho accennato prima, oltre il 60% del mercato delle criptovalute è Bitcoin. Nelle prime 5, è vicino all'80%. In un certo senso, è in una categoria a sé stante. Se ponderi qualsiasi portafoglio per capitalizzazione di mercato, sarà naturalmente per lo più BTC, ma crea anche un caso per separare completamente questi segmenti: mantenere la maggior parte del tuo investimento in Bitcoin archiviato sul tuo portafoglio hardware senza alcun ribilanciamento e creare un portafoglio indicizzato di altcoin.

Una cosa è certa: se cerchi una Stagione delle Altcoin, non c'è modo migliore per farlo che con un portafoglio indicizzato ponderato per capitalizzazione di mercato.
...
Se sei orientato a lungo termine e questa visione ti sembra entusiasmante, consolida il tuo [accesso a vita a tutti gli strumenti senza costi aggiuntivi diventando uno dei 1.000 Tassi Leggendari](../../it/upgrade).
