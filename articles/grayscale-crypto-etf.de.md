...
paywall_hook: |
    <ul>
        <li>Zwei Portfolios, um institutionellem Geld zuvorzukommen</li>
    </ul>
...
Am 1. Juli 2025 schlug die SEC [ein neues Kapitel für Krypto-Investitionen auf](https://cointelegraph.com/news/sec-conversion-grayscale-large-cap-crypto-fund-etf), indem sie die Umwandlung des Grayscale Digital Large Cap Fund (GDLC) in einen börsengehandelten Fonds (ETF) genehmigte, der an der NYSE Arca mit einem verwalteten Vermögen von 775 Millionen US-Dollar gehandelt wird.
...
CoinDesk Indices bieten eine einfache Möglichkeit, institutionelle Geldflüsse zu verfolgen. Schauen wir uns die beiden wichtigsten Indizes an: CD20 und CD5 (dem GDLC folgt):
...
<figcaption class="article__figure__caption">CoinDesk 20 Index (CD20) Allokation</figcaption>
</figure>
{:/nomarkdown}

**Vierteljährliches Rebalancing**: Alle drei Monate wird das gesamte Portfolio auf der Grundlage der aktuellen Marktbedingungen neu kalibriert, wobei „Pufferregeln“ einen übermäßigen Umschlag verhindern sollen.

Die Regeln sollen einen übermäßigen Umschlag verhindern, indem sie den aktuellen Indexmitgliedern einen Vorzug geben, im Index zu bleiben, auch wenn sie in den Ranglisten leicht gefallen sind.

CD20 verwendet ein **Puffersystem**:

**Eintrittskriterien**:
1. Ein Vermögenswert muss in den Top **40** nach Handelsvolumen rangieren, um berücksichtigt zu werden  
2. **Top 15 Plätze**:  
- Gehen an die größten Vermögenswerte nach Marktkapitalisierung (unabhängig vom aktuellen Status)  
3. **Verbleibende 5 Plätze**:  
- Aktuelle Mitglieder, die nach Marktkapitalisierung auf den Plätzen 16-25 rangieren, erhalten den Vorzug  
- Wenn nicht genügend aktuelle Mitglieder qualifiziert sind, füllen die höchstrangigen neuen Vermögenswerte die verbleibenden Plätze  

**Austrittskriterien**: Ein bestehender Vermögenswert verliert seinen Platz, wenn er entweder:  
1. Unter Rang **50** im Handelsvolumen fällt (Liquiditätsversagen), ODER  
2. Unter Rang **25** in der Marktkapitalisierung fällt (Größenversagen)  

Ohne Pufferregeln würden Vermögenswerte, die um die Grenzlinie schwanken, ständig jedes Quartal hinzugefügt und entfernt, was zu unnötigen Transaktionskosten und Instabilität führen würde.

### CoinDesk 5

Es ist jedoch nicht der CD20, der für den ersten Multi-Krypto-ETF verwendet wird, sondern sein jüngerer Bruder:

**CD5** repräsentiert die Top 5 Vermögenswerte aus CD20, ausgewählt nach **Marktkapitalisierung** aus den bereits geprüften CD20-Bestandteilen. Da CD20 bereits strenge Liquiditätsfilter anwendet (einschließlich des Handelsvolumen-Screenings), erbt CD5 diese Qualitätsstandards und konzentriert sich auf die größten, liquidesten Vermögenswerte.

Der Index ist viel jünger und hat noch keine gleichwertige Online-Abdeckung, aber bei der Untersuchung seiner Konstruktion wird deutlich, dass er für den Einsatz durch Institutionen gedacht war.

Der Hauptunterschied zu CD20 besteht darin, dass **die Obergrenzen entfernt werden**. Während CD20 den größten Bestandteil auf 30 % und andere auf 20 % begrenzt, verwendet CD5 eine reine Marktkapitalisierungsgewichtung. Dies führt dazu, dass Bitcoin derzeit über 80 % der Allokation erreicht – eine Realitätsprüfung, die die dominante Marktposition und das Liquiditätsprofil von Bitcoin widerspiegelt. Diese Konzentration ist ein Merkmal, kein Fehler – sie stellt sicher, dass der Index die wahre Marktkapitalisierungshierarchie der liquidesten Krypto-Assets widerspiegelt.

Wie CD20 folgt auch CD5 demselben vierteljährlichen Rebalancing-Zeitplan, verwendet jedoch eine einfachere **4/6-Pufferregel**: Die Top 4 Vermögenswerte nach Marktkapitalisierung aus CD20 werden automatisch aufgenommen, während bestehende Mitglieder auf den Plätzen 5 oder 6 den Vorzug erhalten, zu bleiben. Dieses optimierte Verfahren macht CD5 besonders geeignet für die ETF-Implementierung, da es die Komplexität reduziert und gleichzeitig strenge institutionelle Standards beibehält.
...
<figcaption class="article__figure__caption">CoinDesk 5 Index (CD5) Allokation</figcaption>
</figure>
{:/nomarkdown}
...
ETF Store President [Nate Geraci sieht weitreichendere Auswirkungen](https://twitter.com/NateGeraci/status/1939454629915619403) und deutet an, dass diese Genehmigung den Weg für einzelne Spot-ETFs für Vermögenswerte wie XRP, Solana und Litecoin ebnen könnte. Dies würde es Anlegern ermöglichen, gezieltes Engagement in bestimmte Kryptowährungen über traditionelle Anlagekonten zu erhalten.
