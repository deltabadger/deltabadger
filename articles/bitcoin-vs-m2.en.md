...
The [HODL Waves](https://www.unchained.com/hodlwaves) shows the percentage of Bitcoin held for over a year, revealing:
...
**1. Global Liquidity (Chart 1):**
- Global M2 shows a strong upward trajectory since late 2024
- The 12-week lead suggests continued liquidity expansion
- Bitcoin has been tracking this liquidity increase closely

**2. MVRV Z-Score (Chart 2):**
- Currently at 2.16 (as of June 22, 2025)
- This is in the elevated range but not at extreme overvaluation levels
- Historical peaks occurred around 7-10+ Z-score levels
- Still room for upward movement before hitting dangerous overvaluation territory

**3. HODL Waves (Chart 3):**
- Long-term holders (1+ year) appear to still be holding significant positions
- No major distribution pattern visible yet
- Supply-side pressure remains contained

### Price Prediction

**Near-term (6-12 months): Bullish**
- Global liquidity expansion strongly favors Bitcoin appreciation
- MVRV Z-score suggests room for further upside before extreme overvaluation
- Current price around $110k could continue higher

**Potential targets:**
- Next resistance levels likely in the $120k-150k range
- If liquidity conditions remain favorable, Bitcoin could reach $150k-200k+ before showing signs of exhaustion

**Key risks to monitor:**
- MVRV Z-score approaching 6+ levels (historically dangerous territory)
...
1. **Watch Global M2**: Bitcoin has historically followed global money supply trends with 83% directional consistency over 12-month periods. This doesn't give precise timing, but helps identify the overall macro environment - rising M2 often signals potential Bitcoin strength over longer timeframes.

2. **Check Internal Metrics**: Use MVRV Z-score and HODL waves to identify when Bitcoin might decouple from liquidity trends:
   - High Z-score = Be careful, even with good liquidity
   - Low Z-score + High liquidity = Potential buying opportunity

3. **Consider the Context**: Bitcoin's relationship with liquidity may evolve as the asset matures, institutional adoption grows, and new fundamental drivers emerge.
