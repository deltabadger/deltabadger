---
title: "Decodificare l'ETF <span class=nobreak>multi-crypto di Grayscale</span>"
...
Il 1° luglio 2025, la SEC ha [aperto un nuovo capitolo per gli investimenti in criptovalute](https://cointelegraph.com/news/sec-conversion-grayscale-large-cap-crypto-fund-etf) approvando la trasformazione del Grayscale Digital Large Cap Fund (GDLC) in un Exchange-Traded Fund (ETF) a pronti, che sarà negoziato su NYSE Arca con 775 milioni di dollari di asset in gestione.
...
L'[Indice CoinDesk 20 (CD20)](https://indices.coindesk.com/coindesk20) prende questo universo vagliato e aggiunge un ulteriore livello di gestione del portafoglio. È anche la parte dell'offerta meglio documentata online.

**Ponderazione per capitalizzazione di mercato con paletti**: La ponderazione per capitalizzazione di mercato dell'indice, che gli utenti di Deltabadger conoscono dal [bot DCA ribilanciato](https://deltabadger.com/academy/rebalanced-dca), è aggiustata aggiungendo dei limiti (massimo 30% per il più grande, 20% per gli altri). Non è molto chiaro il motivo per cui sia stato aggiunto il limite, e la documentazione ufficiale di CoinDesk non lo spiega.
...
<figcaption class="article__figure__caption">Allocazione dell'Indice CoinDesk 20 (CD20)</figcaption>
</figure>
{:/nomarkdown}

**Ribilanciamento trimestrale**: Ogni tre mesi, l'intero portafoglio viene ricalibrato in base alle attuali condizioni di mercato, con "regole cuscinetto" per prevenire un turnover eccessivo.

Le regole sono progettate per prevenire un turnover eccessivo dando ai componenti attuali dell'indice una preferenza a rimanere nell'indice anche se sono leggermente scesi in classifica.

CD20 utilizza un **sistema cuscinetto**:

**Criteri di ingresso**:
1. Un asset deve classificarsi tra i primi **40** per volume di scambi per essere considerato  
2. **Primi 15 posti**:  
- Vanno agli asset più grandi per capitalizzazione di mercato (indipendentemente dallo stato attuale)  
3. **Restanti 5 posti**:  
- I componenti attuali classificati dal 16° al 25° posto per capitalizzazione di mercato hanno la preferenza  
- Se non si qualificano abbastanza componenti attuali, i nuovi asset con il ranking più alto riempiono i posti rimanenti  

**Criteri di uscita**: Un asset esistente perde il suo posto se:  
1. Scende al di sotto della posizione **50** nel volume di scambi (fallimento di liquidità), OPPURE  
2. Scende al di sotto della posizione **25** nella capitalizzazione di mercato (fallimento di dimensione)  

Senza regole cuscinetto, gli asset che si aggirano intorno alla linea di demarcazione verrebbero costantemente aggiunti e rimossi ogni trimestre, creando costi di transazione e instabilità inutili.

### CoinDesk 5

Tuttavia, non è il CD20 ad essere utilizzato per il primo ETF multi-crypto, ma il suo fratello minore:

**CD5** rappresenta i primi 5 asset di CD20, selezionati per **capitalizzazione di mercato** dai componenti già vagliati di CD20. Poiché CD20 applica già rigidi filtri di liquidità (incluso lo screening del volume di scambi), CD5 eredita questi standard di qualità concentrandosi sugli asset più grandi e liquidi.

L'indice è molto più giovane e manca ancora di una copertura online equivalente, ma studiando la sua costruzione, è chiaro che era destinato ad essere utilizzato dalle istituzioni.

La differenza chiave rispetto a CD20 è che **i limiti vengono rimossi**. Mentre CD20 limita il componente più grande al 30% e gli altri al 20%, CD5 utilizza una ponderazione per capitalizzazione di mercato pura. Ciò si traduce in un'allocazione attuale di Bitcoin superiore all'80%, un controllo di realtà che riflette la posizione dominante di mercato e il profilo di liquidità di Bitcoin. Questa concentrazione è una caratteristica, non un difetto: garantisce che l'indice rifletta la vera gerarchia della capitalizzazione di mercato degli asset crittografici più liquidi.

Come CD20, anche CD5 segue lo stesso programma di ribilanciamento trimestrale ma utilizza una regola cuscinetto **4/6 più semplice**: i primi 4 asset per capitalizzazione di mercato da CD20 vengono inclusi automaticamente, mentre i componenti esistenti classificati al 5° o 6° posto hanno la preferenza a rimanere. Questo processo semplificato rende CD5 particolarmente adatto all'implementazione di ETF, poiché riduce la complessità mantenendo rigorosi standard istituzionali.
...
<figcaption class="article__figure__caption">Allocazione dell'Indice CoinDesk 5 (CD5)</figcaption>
</figure>
{:/nomarkdown}
...
*Qual è la vostra opinione su questi sviluppi? Investireste in CD5, CD20 o vi atterreste semplicemente a Bitcoin? ETF o portafoglio di indici personalizzato auto-custodito?* 