---
title: "Bitcoin-Treasury-Unternehmen"
subtitle: "Stärken und Schwächen des neuen Marktansatzes für Bitcoin"
author_id: 1
thumbnail: treasury-companies.avif
excerpt: "Treasury-Unternehmen sind ein völlig neuer Marktansatz. Wir untersuchen ihre Stärken und Schwächen sowie die vier neuen Strategy-Ticker."
paywall_hook: |
    <ul>
...
Während Michael Saylors Riese immer noch fast 65% der Unternehmens-Bitcoins hält, listet [bitcointreasuries.net](https://bitcointreasuries.net) 168 Unternehmen aus 29 Ländern auf.

{::nomarkdown}
<figure class="article__figure">
<img class="has-shadow" src="https://deltabadger.com/images/articles/bitcoin-treasury-companies/top-100-public-companies.avif" alt="Bitcoin Treasury Unternehmen">
<figcaption class="article__figure__caption">Top 100 Bitcoin-Treasury-Unternehmen (Aug 2025)</figcaption>
</figure>
{:/nomarkdown}
...
{::nomarkdown}
<figure class="article__figure" data-controller="pie-chart" data-pie-chart-data-value="blue,US,Vereinigte Staaten,91.54
#ff7f0e,JP,Japan,2.26
#2ca02c,CA,Kanada,1.73
#d62728,CN,China,1.30
#9467bd,FR,Frankreich,0.55
#8c564b,HK,Hongkong,0.44
#e377c2,DE,Deutschland,0.43
#7f7f7f,GB,Vereinigtes Königreich,0.41
#bcbd22,SG,Singapur,0.36
#17becf,KY,Kaimaninseln,0.26
#aec7e8,SE,Schweden,0.10
#ffbb78,KR,Südkorea,0.09
COLUMN_BREAK
#98df8a,NO,Norwegen,0.09
#ff9896,TH,Thailand,0.07
#c5b0d5,BR,Brasilien,0.06
#c49c94,AR,Argentinien,0.06
#f7b6d2,MT,Malta,0.05
#c7c7c7,AE,VAE,0.05
#dbdb8d,AU,Australien,0.05
#9edae5,TR,Türkei,0.04
#393b79,JE,Jersey,0.02
#637939,GI,Gibraltar,0.02
#8c6d31,ES,Spanien,0.01">
...
<figcaption class="article__figure__caption">Bitcoin-Bestände in Top 100 Treasury-Unternehmen nach Ländern</figcaption>
</figure>
{:/nomarkdown}

In meinem X-Artikel beschreibe ich kurz jedes Unternehmen der Top 100, aber zuerst:
...
>
> —Andy Constan bei [What Bitcoin Did](https://www.youtube.com/watch?v=BbgR5ceiqL4)
...
>
> Lyn Alden bei [What Bitcoin Did](https://www.youtube.com/watch?v=BbgR5ceiqL4)
...
{::nomarkdown}
<figure class="article__figure">
<img class="has-shadow" src="https://deltabadger.com/images/articles/bitcoin-treasury-companies/mnav-premium.avif" alt="Strategys mNAV-Aufschlag">
<figcaption class="article__figure__caption">Strategys mNAV-Aufschlag (August 2023)</figcaption>
</figure>
{:/nomarkdown}
...
Bitcoin-Forscher Pierre Rochard beschrieb zuerst die Idee von [Bitcoin als spekulativem Angriff](https://nakamotoinstitute.org/mempool/speculative-attack/), als es winzig war – dass, während es größer wird, Kapitalpools unvermeidlich Wege finden würden, „Fiat-Währung zu shorten und Bitcoin long zu gehen".
...
## Welcher Strategy-Ticker ist für Sie?

Strategy wird derzeit unter 5 Tickern gehandelt: MSTR, STRK, STRF, STRD, STRC.

Neue Ticker feiern Strategys Rebranding mit allen Namen, die mit STR- beginnen. Als Teil von Strategys neuem Kapitalakquisitionsansatz bieten sie alle attraktive Festzinsen:

**STRK (Strike) 8%**

Der einzige mit Eigenkapital-Aufwärtsbeteiligung. Auch der einzige, der im Verhältnis 10:1 in Stammaktien umwandelt, wenn MSTR 1.000 Dollar erreicht, was Ihnen erlaubt, Bitcoins potenzielles explosives Wachstum über das bloße Sammeln von Dividenden hinaus mitzufahren.

**STRF (Strife) 10%**

Kaufen Sie für Dividendensicherheit – verpasste Zahlungen werden zusätzlich mit 1% jährlich bis zu 18% verzinst, was die stärkste Anreizstruktur für Strategy schafft, Zahlungen aufrechtzuerhalten.

**STRD (Stride) 10%**

Kaufen Sie für die höchste aktuelle Rendite von 10% mit dem Verständnis, dass Sie nicht-kumulatives Risiko im Austausch für diesen Aufschlag über STRKs 8% eingehen.

**STRC (Stretch) 9%**

Kaufen Sie für das höchste Sicherheitsranking und monatliches Einkommen – es steht senior zu STRK, STRD und Stammaktien in der Kapitalstruktur, was bedeutet, dass es vor ihnen bezahlt wird, wenn es Cashflow-Probleme gibt, während es auch monatliche statt vierteljährliche Dividendenzahlungen bietet.

### Das Juwel

*STRK (Strike) ist als Anlageinstrument am interessantesten*, weil es im Wesentlichen eine gehebelte Bitcoin-Wette mit Verlustschutz ist.

Hier ist, warum es einzigartig überzeugend ist: Sie erhalten eine 8%-Dividenden-Untergrenze (die Einkommen bietet, selbst wenn Bitcoin stagniert), aber wenn Bitcoin MSTR über 1.000 Dollar treibt, können Sie im Verhältnis 10:1 umwandeln und an unbegrenztem Aufwärtspotenzial teilhaben.

Die anderen sind geradliniger: STRF/STRD sind nur hochverzinsliche Anleihen mit Bitcoin-Korrelation, und STRC versucht, ein langweiliger Sparkonto-Ersatz zu sein. Aber STRK ist der einzige, der potenziell eine 100-Dollar-Investition in etwas viel Größeres verwandeln könnte, wenn die Bitcoin-These wirklich explodiert – während er Sie trotzdem fürs Warten bezahlt.

Also bietet Strike:
- 8% jährliche Dividende (sofortiges Einkommen)
- Unbegrenztes Aufwärtspotenzial, wenn MSTR über 1.000 Dollar geht via 10:1-Umwandlung
- 100-Dollar-Untergrenze-Schutz (Liquidationspräferenz)
- Verlustschutz während Bitcoin-Bärenmärkten

Risiken bleiben: mNAV-Kompression während Bärenmärkten könnte Strategys Fähigkeit beeinträchtigen, Dividendenzahlungen aufrechtzuerhalten, und die Umwandlungsfunktion funktioniert nur, wenn Bitcoins langfristige Trajektorie nach oben fortsetzt.

Dennoch ist STRK der interessanteste Bitcoin-bezogene Ticker auf dem Markt.

Schauen Sie sich unser [vorheriges Playbook](../radical-portfolio-theory/) an, wo wir den Platz für STRK in der Radikalen Portfoliotheorie diskutieren.

{::nomarkdown}
<figure class="article__figure" data-controller="pie-chart" data-pie-chart-data-value="#FA660F,STRK,Strategy Vorzugsaktie,60
#f7941d,BTC,Bitcoin,40">
<div class="pie-chart-wrapper">
<svg data-pie-chart-target="svg" width="300" height="300" class="pie-chart"></svg>
<div data-pie-chart-target="legend" class="pie-legend"></div>
</div>
<figcaption class="article__figure__caption">Radikales Portfolio für Bitcoin-Maximalisten</figcaption>
</figure>
{:/nomarkdown}

### Wer kauft den „Master"?

Warum MSTR kaufen? Weil es vollständiges Exposure zum Eigenkapitalwachstum gibt.

Heute kostet STRK 106 Dollar und für 10 davon (1.060 Dollar) kaufen Sie das Umwandlungsrecht für 1 MSTR-Aktie, die derzeit 366 Dollar kostet, aber Sie erhalten 8% jährlich auf Ihr Kapital, das potenziell reinvestiert werden kann. Also hängt davon ab, welches langfristig ein besseres Geschäft ist, von Volatilität und Wachstumsgeschwindigkeit ab.

Was das in der Praxis bedeutet:

Je näher MSTR an 1.000 Dollar kommt, desto mehr wird der Aufschlag auf STRK komprimiert, also während Sie derzeit 0,28 von MSTR dafür zahlen, wird es zur Umwandlungszeit sehr nahe bei 0,1 sein.
