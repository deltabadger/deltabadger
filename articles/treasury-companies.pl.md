---
title: "Bitcoinowe spółki skarbcowe"
subtitle: "Mocne i słabe strony nowej strategii rynkowej na Bitcoina"
author_id: 1
thumbnail: treasury-companies.avif
excerpt: "Spółki skarbcowe to całkowicie nowa strategia rynkowa. Badamy ich mocne i słabe strony oraz cztery nowe tickery Strategy."
paywall_hook: |
    <ul>
        <li>STRK, STRF, STRD, STRC — Zrozumienie możliwości z nowymi tickerami Strategy</li>
    </ul>
...
Podczas gdy gigant Michaela Saylora nadal posiada prawie 65% korporacyjnych bitcoinów, [bitcointreasuries.net](https://bitcointreasuries.net) wymienia 168 firm z 29 krajów.

{::nomarkdown}
<figure class="article__figure">
<img class="has-shadow" src="https://deltabadger.com/images/articles/bitcoin-treasury-companies/top-100-public-companies.avif" alt="Bitcoinowe spółki skarbcowe">
<figcaption class="article__figure__caption">Top 100 bitcoinowych spółek skarbcowych (sierpień 2025)</figcaption>
</figure>
{:/nomarkdown}
...
{::nomarkdown}
<figure class="article__figure" data-controller="pie-chart" data-pie-chart-data-value="blue,US,Stany Zjednoczone,91.54
#ff7f0e,JP,Japonia,2.26
#2ca02c,CA,Kanada,1.73
#d62728,CN,Chiny,1.30
#9467bd,FR,Francja,0.55
#8c564b,HK,Hongkong,0.44
#e377c2,DE,Niemcy,0.43
#7f7f7f,GB,Wielka Brytania,0.41
#bcbd22,SG,Singapur,0.36
#17becf,KY,Kajmany,0.26
#aec7e8,SE,Szwecja,0.10
#ffbb78,KR,Korea Południowa,0.09
COLUMN_BREAK
#98df8a,NO,Norwegia,0.09
#ff9896,TH,Tajlandia,0.07
#c5b0d5,BR,Brazylia,0.06
#c49c94,AR,Argentyna,0.06
#f7b6d2,MT,Malta,0.05
#c7c7c7,AE,ZEA,0.05
#dbdb8d,AU,Australia,0.05
#9edae5,TR,Turcja,0.04
#393b79,JE,Jersey,0.02
#637939,GI,Gibraltar,0.02
#8c6d31,ES,Hiszpania,0.01">
...
<figcaption class="article__figure__caption">Zasoby Bitcoina w top 100 spółek skarbcowych według krajów</figcaption>
</figure>
{:/nomarkdown}
...
>
> —Andy Constan w [What Bitcoin Did](https://www.youtube.com/watch?v=BbgR5ceiqL4)
...
>
> Lyn Alden w [What Bitcoin Did](https://www.youtube.com/watch?v=BbgR5ceiqL4)
...
{::nomarkdown}
<figure class="article__figure">
<img class="has-shadow" src="https://deltabadger.com/images/articles/bitcoin-treasury-companies/mnav-premium.avif" alt="Premia mNAV Strategy">
<figcaption class="article__figure__caption">Premia mNAV Strategy (sierpień 2023)</figcaption>
</figure>
{:/nomarkdown}
...
Badacz Bitcoina Pierre Rochard po raz pierwszy opisał ideę [Bitcoina jako spekulacyjnego ataku](https://nakamotoinstitute.org/mempool/speculative-attack/), gdy był maleńki - że w miarę jak rośnie, pule kapitału nieuchronnie znajdą sposoby na "shortowanie waluty fiat i bycie długim na Bitcoinie".
...
## Który ticker Strategy jest dla ciebie?

Strategy jest obecnie notowana pod 5 tickerami: MSTR, STRK, STRF, STRD, STRC.

Nowe tickery świętują rebranding Strategy ze wszystkimi nazwami zaczynającymi się od STR-. W ramach nowego podejścia Strategy do pozyskiwania kapitału, wszystkie oferują atrakcyjne kupony o stałym dochodzie:

**STRK (Strike) 8%**

Jedyny z udziałem w wzrostach kapitału. Także jedyny, który konwertuje na akcje zwykłe w stosunku 10:1, gdy MSTR osiągnie 1000$, pozwalając ci skorzystać z potencjalnego eksplozywnego wzrostu Bitcoina poza samym pobieraniem dywidend.

**STRF (Strife) 10%**

Kup dla bezpieczeństwa dywidend - nieodebrane płatności naliczają się z dodatkowym 1% rocznie do 18%, tworząc najsilniejszą strukturę zachęt dla Strategy do utrzymywania płatności.

**STRD (Stride) 10%**

Kup dla najwyższej bieżącej stopy zwrotu na poziomie 10% z rozumieniem, że podejmujesz ryzyko niekumulacyjne w zamian za tę premię ponad 8% STRK.

**STRC (Stretch) 9%**

Kup dla najwyższego rankingu bezpieczeństwa i miesięcznego dochodu - jest nadrzędny względem STRK, STRD i akcji zwykłych w strukturze kapitałowej, co oznacza, że jest płacony przed nimi, jeśli są problemy z przepływem środków pieniężnych, jednocześnie zapewniając miesięczne zamiast kwartalnych płatności dywidend.

### Klejnot

*STRK (Strike) jest najbardziej interesujący jako instrument inwestycyjny*, ponieważ jest zasadniczo dźwignią zakładu na Bitcoina z ochroną przed spadkami.

Oto dlaczego jest wyjątkowo przekonujący: Otrzymujesz podłogę dywidend na poziomie 8% (zapewniającą dochód nawet jeśli Bitcoin stagnuje), ale jeśli Bitcoin pchnie MSTR powyżej 1000$, możesz konwertować w stosunku 10:1 i uczestniczyć w nieograniczonym potencjale wzrostowym.

Pozostałe są bardziej proste: STRF/STRD to tylko obligacje o wysokiej rentowności z korelacją z Bitcoinem, a STRC próbuje być nudną alternatywą dla konta oszczędnościowego. Ale STRK jest jedynym, który potencjalnie mógłby zamienić inwestycję 100$ w coś znacznie większego, jeśli teza o Bitcoinie naprawdę eksploduje - jednocześnie płacąc ci za czekanie.

Więc Strike oferuje:
- 8% rocznej dywidendy (natychmiastowy dochód)
- Nieograniczony potencjał wzrostowy, jeśli MSTR pójdzie powyżej 1000$ przez konwersję 10:1
- Ochronę podłogi 100$ (preferencja likwidacyjna)
- Ochronę przed spadkami podczas bessach Bitcoina

Ryzyko pozostaje: kompresja mNAV podczas bessach mogłaby wpłynąć na zdolność Strategy do utrzymywania płatności dywidend, a funkcja konwersji działa tylko jeśli długoterminowa trajektoria Bitcoina będzie kontynuowana w górę.

Mimo to, STRK jest najbardziej interesującym tickerem związanym z Bitcoinem na rynku.

Sprawdź nasz [poprzedni Playbook](../radical-portfolio-theory/), gdzie omawiamy miejsce dla STRK w radykalnej teorii portfela.

{::nomarkdown}
<figure class="article__figure" data-controller="pie-chart" data-pie-chart-data-value="#FA660F,STRK,Akcje uprzywilejowane Strategy,60
#f7941d,BTC,Bitcoin,40">
<div class="pie-chart-wrapper">
<svg data-pie-chart-target="svg" width="300" height="300" class="pie-chart"></svg>
<div data-pie-chart-target="legend" class="pie-legend"></div>
</div>
<figcaption class="article__figure__caption">Radykalny portfel dla maksymalistów Bitcoina</figcaption>
</figure>
{:/nomarkdown}

### Kto kupuje "Mistrza"?

Dlaczego kupować MSTR? Ponieważ daje pełną ekspozycję na wzrost kapitału.

Dziś STRK kosztuje 106$ i za 10 z nich (1060$), kupujesz prawo konwersji na 1 akcję MSTR, która obecnie wynosi 366$, ale otrzymujesz 8% rocznie na swój kapitał, który może być potencjalnie reinwestowany. Więc które jest lepszą długoterminową ofertą, zależy od zmienności i szybkości wzrostu.

Co to oznacza w praktyce:

Im bliżej MSTR zbliży się do 1000$, tym bardziej premia na STRK będzie kompresowana, więc podczas gdy obecnie płacisz 0,28 MSTR za to, w czasie konwersji będzie to bardzo blisko 0,1.
