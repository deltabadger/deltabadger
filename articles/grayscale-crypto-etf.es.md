---
title: "Descifrando el ETF <span class=nobreak>multicripto de Grayscale</span>"
...
El 1 de julio de 2025, la SEC [abrió un nuevo capítulo para la inversión en criptomonedas](https://cointelegraph.com/news/sec-conversion-grayscale-large-cap-crypto-fund-etf) al aprobar la transformación del Grayscale Digital Large Cap Fund (GDLC) en un Fondo Cotizado en Bolsa (ETF) al contado, que se negociará en NYSE Arca con 775 millones de dólares en activos bajo gestión.
...
CD5 se encuentra en la cima de una **metodología de cuatro niveles** desarrollada por [CoinDesk Indices](https://indices.coindesk.com/). A diferencia de los populares rankings de capitalización de mercado en sitios como CoinGecko o CoinPaprika, CD5 fue creado específicamente para inversores institucionales. Esto significa que su compleja metodología puede sorprender a los entusiastas de las criptomonedas: es mucho más selectiva que simplemente elegir las monedas más grandes por capitalización de mercado.

{::nomarkdown}
<figure class="article__figure">
<img src="https://deltabadger.com/images/articles/coindesk-methodology.svg" alt="Las cuatro capas de la Metodología CoinDesk">
<figcaption class="article__figure__caption">Los cuatro niveles de la Metodología CoinDesk</figcaption>
</figure>
{:/nomarkdown}
...
El [Índice CoinDesk 20 (CD20)](https://indices.coindesk.com/coindesk20) toma este universo examinado y añade una capa adicional de gestión de cartera. También es la parte de la oferta mejor documentada en línea.

**Ponderación por capitalización de mercado con barreras de protección**: La ponderación por capitalización de mercado del índice, que los usuarios de Deltabadger conocen del [bot de DCA reequilibrado](https://deltabadger.com/academy/rebalanced-dca/), se ajusta añadiendo límites (30% máximo para el más grande, 20% para otros). No está del todo claro por qué se ha añadido el límite, y la documentación oficial de CoinDesk no lo explica.
...
**Reequilibrio trimestral**: Cada tres meses, toda la cartera se recalibra en función de las condiciones actuales del mercado, con "reglas de búfer" para evitar una rotación excesiva.

Las reglas están diseñadas para evitar una rotación excesiva dando a los constituyentes actuales del índice una preferencia para permanecer en el índice incluso si han caído ligeramente en las clasificaciones.

CD20 utiliza un **sistema de búfer**:

**Criterios de entrada**:
1. Un activo debe estar entre los **40** primeros por volumen de negociación para ser considerado  
2. **Los 15 primeros puestos**:  
- Van a los activos más grandes por capitalización de mercado (independientemente del estado actual)  
3. **Los 5 puestos restantes**:  
- Los constituyentes actuales clasificados entre el 16 y el 25 por capitalización de mercado tienen preferencia  
- Si no hay suficientes constituyentes actuales que califiquen, los nuevos activos mejor clasificados ocupan los puestos restantes  

**Criterios de salida**: Un activo existente pierde su lugar si:  
1. Cae por debajo del puesto **50** en volumen de negociación (fallo de liquidez), O  
2. Cae por debajo del puesto **25** en capitalización de mercado (fallo de tamaño)  

Sin reglas de búfer, los activos que rondan la línea de corte serían añadidos y eliminados constantemente cada trimestre, creando costes de transacción e inestabilidad innecesarios.

### CoinDesk 5

Sin embargo, no es el CD20 el que se utiliza para el primer ETF multi-cripto, sino su hermano menor:

**CD5** representa los 5 principales activos de CD20, seleccionados por **capitalización de mercado** de entre los constituyentes ya examinados de CD20. Dado que CD20 ya aplica estrictos filtros de liquidez (incluido el cribado por volumen de negociación), CD5 hereda estos estándares de calidad mientras se centra en los activos más grandes y líquidos.

El índice es mucho más joven y todavía carece de una cobertura en línea equivalente, pero al estudiar su construcción, está claro que fue diseñado para ser utilizado por instituciones.

La diferencia clave con CD20 es que **se eliminan los límites**. Mientras que CD20 limita el constituyente más grande al 30% y otros al 20%, CD5 utiliza una ponderación por capitalización de mercado pura. Esto da como resultado que Bitcoin alcance actualmente más del 80% de la asignación, una constatación que refleja la posición dominante de Bitcoin en el mercado y su perfil de liquidez. Esta concentración es una característica, no un error: asegura que el índice refleje la verdadera jerarquía de capitalización de mercado de los activos cripto más líquidos.

Al igual que CD20, CD5 sigue el mismo calendario de reequilibrio trimestral pero utiliza una **regla de búfer 4/6 más simple**: los 4 principales activos por capitalización de mercado de CD20 se incluyen automáticamente, mientras que los constituyentes existentes clasificados en 5º o 6º lugar tienen preferencia para permanecer. Este proceso simplificado hace que CD5 sea particularmente adecuado para la implementación de ETF, ya que reduce la complejidad mientras mantiene rigurosos estándares institucionales.
