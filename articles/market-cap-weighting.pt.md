---
title: "A Magia da Ponderação por Capitalização de Mercado"
subtitle: 'Como Transformar Qualquer Carteira num Fundo de Índice Pessoal'
author_id: 1
...
[AssetMarketCap](https://assetmarketcap.com) é um ótimo local para verificar as capitalizações de mercado globais de diferentes ativos. O imobiliário lidera a lista, o ouro classifica-se em quarto e a Bitcoin situa-se no décimo oitavo lugar. Aqui estão os 20 principais ativos por capitalização de mercado:

{::nomarkdown}
<figure class="article__figure" data-controller="pie-chart" data-pie-chart-data-value="#1bb200,RE,Imobiliário,69.94
#004081,OIL,Petróleo,11.84
#ff0000,CNY,Yuan Chinês,4.84
#e7b500,GOLD,Ouro,2.40
#228B22,USD,Dólar Americano,2.32
#4169E1,EUR,Euro,1.93
#B87333,CU,Cobre,1.35
#87CEEB,GAS,Gás Natural,0.97
#FF69B4,JPY,Iene Japonês,0.91
...
#20B2AA,TWD,Dólar Taiwanês,0.23
#C0C0C0,AG,Prata,0.23">
...
<figcaption class="article__figure__caption">A Bitcoin representa perto de 80% da alocação total no CoinDesk 5</figcaption>
</figure>
{:/nomarkdown}
...
## Construir o Seu ETF de Cripto Pessoal

Agora que sabemos o quê e porquê, é altura de aplicar este conhecimento na prática. Imediatamente, enfrentamos o primeiro desafio:

### Que Índice Seguir?

Índices populares do mercado de criptomoedas como o CoinMarketCap incluem diferentes tipos de ativos: blockchains de Camada 1 e Camada 2, tokens de exchange, memecoins, stablecoins e mais.

As [Stablecoins](./genius-of-stablecoins) não são ativos de crescimento, pelo que têm de ser excluídas da parte da sua carteira ponderada por capitalização de mercado. Se procura um índice disponível publicamente que o faça, o [Índice CoinMarketCap 100](https://coinmarketcap.com/charts/cmc100) é o caminho a seguir.
...
<figcaption class="article__figure__caption">Índice CoinMarketCap 100 (CMC100)</figcaption>
</figure>
{:/nomarkdown}

Para investidores de retalho, o CMC100 é uma alternativa muito melhor do que os Índices CoinDesk como o CD5 ou CD20. Primeiro, é totalmente público e até oferece um ponto final de API disponível publicamente. Segundo, não aplica filtros institucionais que excluem ativos que muitos investidores querem incluir: moedas de privacidade, tokens de exchange ou memecoins.

Não pode errar ao escolher apenas as 10 principais criptomoedas do CMC100, mas é apenas um convite para o universo dos índices de criptomoedas. O Coingecko lista mais de 500 deles, e pode facilmente imaginar mais. Há apenas uma semana, discutimos um índice de blockchains usadas para transferir stablecoins como uma tese de investimento interessante. As possibilidades são infinitas. <a class="link-source-tile" href="https://www.coingecko.com">coingecko.com</a>

### Índice da Época das Altcoins

Como mencionei anteriormente, mais de 60% do mercado de cripto é Bitcoin. No top 5, está perto dos 80%. De certa forma, está na sua própria categoria. Se ponderar por capitalização de mercado qualquer carteira, será naturalmente maioritariamente BTC, mas também cria um caso para separar completamente esses segmentos: manter a maioria do seu investimento em Bitcoin armazenado na sua carteira de hardware sem qualquer reequilíbrio, e criar uma carteira de índice de altcoins.

Uma coisa é certa: se procura uma Época das Altcoins, não há melhor maneira de o fazer do que com uma carteira de índice ponderada por capitalização de mercado.
...
Se tem uma orientação a longo prazo e essa visão lhe parece entusiasmante, cimente o seu [acesso vitalício a todas as ferramentas sem custos extra, tornando-se um dos 1.000 Texugos Lendários](../../pt/upgrade).
