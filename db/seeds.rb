...
SubscriptionPlanVariant.find_or_create_by!(subscription_plan: basic_plan, years: 0, cost_eur: 8.9, cost_usd: 9.9)
...
SubscriptionPlanVariant.find_or_create_by!(subscription_plan: pro_plan, years: 0, cost_eur: 27, cost_usd: 29)
